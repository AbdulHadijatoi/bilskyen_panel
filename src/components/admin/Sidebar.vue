    ...
    <div class="sidebar-header" :style="{ flexShrink: 0, padding: '0.75rem' }">
      ...
      >
        ...
        >
          ...
          <div class="text-xs truncate" style="opacity: 0.7;">Admin Panel</div>
        </div>
      </div>
    </div>
...
.admin-sidebar :deep(.v-list-item__spacer) {
...
.admin-sidebar.v-navigation-drawer--rail :deep(.v-list-item__prepend) {
  display: flex !important;
  visibility: visible !important;
  opacity: 1 !important;
...
.admin-sidebar.v-navigation-drawer--rail :deep(.v-list-item__prepend .v-icon) {
  display: block !important;
  visibility: visible !important;
  opacity: 1 !important;
}

.admin-sidebar.v-navigation-drawer--rail :deep(.v-list-item) {
  justify-content: center !important;
  min-height: 32px !important;
  height: 32px !important;
}

.admin-sidebar.v-navigation-drawer--rail :deep(.v-list-item__content) {
  display: none !important;
}
