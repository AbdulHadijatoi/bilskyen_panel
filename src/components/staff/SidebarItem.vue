...
import type { SidebarSectionItem } from '@/constants/staff'

const NAV_TITLE_KEYS: Record<string, string> = {
  Dashboard: 'staff.nav.dashboard',
  Vehicles: 'staff.nav.vehicles',
  Overview: 'staff.nav.overview',
  'Add Vehicle': 'staff.nav.addVehicle',
  Leads: 'staff.nav.leads',
  Enquiries: 'staff.nav.enquiries',
  Subscription: 'staff.nav.subscription',
  'Audit Logs': 'staff.nav.auditLogs',
}
