    ...
    <template #append>
      <div class="sidebar-footer" :style="{ padding: '0.75rem', flexShrink: 0, borderTop: '1px solid var(--sidebar-border)' }">
        <v-menu location="top">
          ...
          <v-list>
            <v-list-item :to="{ name: 'staff.profile' }" prepend-icon="mdi-account">
...
const SECTION_TITLE_KEYS: Record<string, string> = {
  'Core Operations': 'staff.navSection.coreOperations',
  Management: 'staff.navSection.management',
}
...
.staff-sidebar :deep(.v-navigation-drawer__content) {
  display: flex !important;
  flex-direction: column !important;
  height: 100% !important;
...
.staff-sidebar :deep(.v-list-item__spacer) {
...
.staff-sidebar.v-navigation-drawer--rail :deep(.v-list-item__prepend) {
  display: flex !important;
  visibility: visible !important;
  opacity: 1 !important;
...
.staff-sidebar.v-navigation-drawer--rail :deep(.v-list-item__prepend .v-icon) {
  display: block !important;
  visibility: visible !important;
  opacity: 1 !important;
}

.staff-sidebar.v-navigation-drawer--rail :deep(.v-list-item) {
  justify-content: center !important;
  min-height: 32px !important;
  height: 32px !important;
}

.staff-sidebar.v-navigation-drawer--rail :deep(.v-list-item__content) {
  display: none !important;
}
