<template>
  <div class="panel-page about-page-content-container">
    <PageHeader
      :title="t('admin.views.aboutPageContent.title')"
      :subtitle="t('admin.views.aboutPageContent.description')"
    >
      <template #actions>
        <v-btn
          color="default"
...
async function handleImageFileSelect(sectionKey: string, file: File | File[] | null) {
  ...
  try {
    const uploadedImage = await uploadAboutPageImage(sectionKey, fileToUpload, undefined, 0, 'about')
